    ...
    return ( 
        ...
        <Form className="p-2 font-montS text-sm text-black flex flex-col gap-6">
                ...
                <FormInput
                      ...
                      type="number"
                    />
                    <button type={book ? 'button' : 'submit'}  className="text-white disabled:text-red-300" >Check out</button>
     ...
     {isSent &&    <div>
        ...
        {nights} Nights
                        ...
                        <hr className=" bg-white shadow-none border-none h-0.5 my-6" />
                        <button type="submit" onClick={() => setBook(true) && onSubmit()} className="ml-auto block bg-passionOrange uppercase text-purpleBlack px-12 w-fit font-semibold h-12 text-sm shadow-md drop-shadow-md">
                        Book
                        </button>
                    </div>}

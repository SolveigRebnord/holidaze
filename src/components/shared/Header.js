        ...
        <div className="flex flex-row gap-6 md:gap-8 justify-end items-center w-full">
          ...
          <div className=" w-full md:hidden">
            ...
            {isComponentVisible && (
              <div
                ref={ref}
                className="burger whitespace-nowrap bg-purpleBlack border-2 flex justify-center border-mainBeige absolute top-0 left-0 w-3/4 h-screen rounded-md z-20 shadow-lg transition ease-in-out delay-500 duration-2000"
              >

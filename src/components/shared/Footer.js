...
const Footer = () => {
  ...
  const menuItems = [{title: 'Home', link: '/'}, {title: 'Venues', link: 'venues'}, {title: 'Profile', link: 'account'}];

  
  return <footer className="h-72 bg-passionOrange mt-20 p-4 lg:p-8 gap-14 lg:gap-0 flex flex-col justify-end items-center">
